...
INDEX = Path(r"c:/Users/depaoll/Downloads/chatbot/processed_ecb_data/ecb_token_chunks.faiss")
META  = Path(r"c:/Users/depaoll/Downloads/chatbot/processed_ecb_data/faiss_meta_token.json")
SIDECAR = Path(r"c:/Users/depaoll/Downloads/chatbot/processed_ecb_data/speech_sidecar_token_chunks.json")
